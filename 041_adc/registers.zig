...
pub const ADC1:  *volatile ADC_type     = @ptrFromInt(ADC1_BASE);
pub const ADC2:  *volatile ADC_type     = @ptrFromInt(ADC2_BASE);
pub const ADC3:  *volatile ADC_type     = @ptrFromInt(ADC3_BASE);
